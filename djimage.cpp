...
int djImage::LoadTGA( const char * szFilename )
{
	...
	{
		printf( "djImage::LoadTGA(%s): Couldn't open file\n", szFilename );
		return -1;
	}
...
int djImage::Save( const char * szFilename, int iWidth, int iHeight, int ibpp )
{
	djMSG("IMAGE:SAVE: FIXME: STUB\n");
	return 0;
}
