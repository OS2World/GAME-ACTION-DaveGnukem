...
int iJumpNormal[] = { -1, -1, -1,  0,  0, 0,  1,  1,  1 };
int iJumpBoots[]  = { -1, -1, -1, -1,  0,  0, 0,  1,  1,  1,  1 };
//struct SJumpInfo jumpNormal = {  9, iJumpNormal }; // "Normal" jump offsets
//struct SJumpInfo jumpBoots  = { 11, iJumpBoots  }; // Jump offsets with boots


// NOTE: I've made these 1 less than they are, so that the last one is always just
// a "natural" falling .. which allows dust to be kicked up. There is still a bug
...
struct SJumpInfo jumpNormal = {  8, iJumpNormal }; // "Normal" jump offsets
struct SJumpInfo jumpBoots  = { 10, iJumpBoots  }; // Jump offsets with boots
